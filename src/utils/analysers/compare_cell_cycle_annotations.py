# compare cell cycle annotations module

print('initializing...')  # noqa

# Code destined to comparing annotation
# strategies (braind/fornma).
...
def get_args_dict() -> dict:
    ...
    description = 'compare cell cycle annotations module'
...
def get_image_metrics(images_folder: str,
    ...
    for index_zip in indices_zip:
        ...
        if current_cost < iou_threshold_cost:
            ...
            annotation_class = str(annotation_row['class'])
            ...
            # checking if detection/annotation class match

            if detection_class == 'G1' and annotation_class == 'G1':

                # updating true positives
                true_positives += 1

            if detection_class == 'G2' and annotation_class == 'G2':

                # updating true negatives
                true_negatives += 1

            if detection_class == 'G1' and annotation_class == 'G2':

                # updating false positives
                false_positives += 1

            if detection_class == 'G2' and annotation_class == 'G1':
...
def create_annotation_comparison_df(images_folder: str,
    ...
    for image_index, (image_name, image_group) in enumerate(image_groups, 1):
        ...
        for iou in iou_thresholds:
            ...
            for dt in detection_thresholds:
                ...
                tp, tn, fp, fn = get_image_metrics(images_folder=images_folder,
...
def generate_annotation_comparison_df(images_folder: str,
                                      images_extension: str,
                                      fornma_file: str,
                                      detections_file: str,
                                      output_folder: str,
    ...
    detection_metrics_df = create_annotation_comparison_df(images_folder=images_folder,
                                                           images_extension=images_extension,
                                                           df=merged_df,
                                                           iou_thresholds=iou_thresholds,
                                                           detection_thresholds=detection_thresholds,
    ...
    # TODO: add further analyser and plots here
...
def main():
    ...
    # running generate_annotation_comparison_df function
    generate_annotation_comparison_df(images_folder=images_folder,
                                      images_extension=images_extension,
