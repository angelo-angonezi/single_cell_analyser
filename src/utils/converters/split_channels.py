...
def get_args_dict() -> dict:
    ...
    description = 'split channels module - join red/green data into single image'
    ...
    parser.add_argument('-o', '--output-folder-path',
                        ...
                        type=str,
                        help='defines path to folder which will contain splitd images (.tif)',
                        required=True)
...
def split_single_image(red_image_path: str,
    ...
    saves images split into output path.
    ...
    # merging images
    split_image = np_add(red_image, green_image)
    split_image_normalized = np_add(red_image_normalized, green_image_normalized)

    # print(split_image_normalized)
    # print(np_max(split_image_normalized))
    # print(np_min(split_image_normalized))
    ...
    #              data=split_image_normalized)


def split_multiple_images(red_images_paths: list,
    ...
    for img_index, (red_image_path, green_image_path) in enumerate(red_green_zip, 1):
        ...
        split_single_image(red_image_path=red_image_path,
    ...
    # printing execution message
    f_string = f'all {total_imgs_num} images splitd!'
    print(f_string)
...
def split_channels(red_images_folder: str,
    ...
    if red_matches_green(red_images=red_images,
        ...
        split_multiple_images(red_images_paths=red_images_paths,
...
def main():
    ...
    split_channels(red_images_folder=red_folder_path,
